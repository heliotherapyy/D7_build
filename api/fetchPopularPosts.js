...
var fetchPopularPosts = function fetchPopularPosts(user, q, res) {
  var userId = user.id;
  var page = q.page;
  ...
  _models2.default.Post.forge().orderBy("-likeCount").fetchPage({
    pageSize: 20,
    page: page,
...
exports.default = fetchPopularPosts;
//# sourceMappingURL=fetchPopularPosts.js.map
